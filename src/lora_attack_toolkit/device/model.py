...
class SimulatedDevice:
    ...
    def parse_downlink(self, phy_payload: bytes) -> dict[str, Any]:
        ...
        # Verify MIC
        from lora_attack_toolkit.lorawan.protocol.crypto_v103 import data_mic
        ...
        if f_port == 0 and frm_payload:
            ...
            from lora_attack_toolkit.lorawan.protocol.crypto_v103 import lorawan_payload_cipher
